...
export const adminEntitiesAPI = {
    ...
    updateLab: async (id, data) => (await apiClient.put(`/api/admin-entities/labs/${id}`, data)).data,
    ...
    updatePharmacy: async (id, data) => (await apiClient.put(`/api/admin-entities/pharmacies/${id}`, data)).data,
    ...
    updateReception: async (id, data) => (await apiClient.put(`/api/admin-entities/receptions/${id}`, data)).data,
...
export const clinicAPI = {
    ...
    createStaff: async (data) => (await apiClient.post('/api/clinic/staff', data)).data,
    deleteStaff: async (id) => (await apiClient.delete(`/api/clinic/staff/${id}`)).data,
};
