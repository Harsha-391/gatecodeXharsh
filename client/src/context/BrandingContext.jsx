...
export const BrandingProvider = ({ children }) => {
    ...
    const [hospitalName, setHospitalName] = useState(() => localStorage.getItem('hospitalBrandingName') || 'Medical HMS');
