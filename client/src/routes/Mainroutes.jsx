                  ...
                  <SubdomainRoleGuard>
                    <Routes>
                        ...
                        <Route path="patient/:id" element={<ProtectedRoute requiredPermissions={[]}><UnifiedPatientProfile /></ProtectedRoute>} />
                            ...
                            <Route path="billing/dashboard" element={<ProtectedRoute requiredPermissions={['billing_view', 'billing_manage']} allowedRoles={['billing', 'cashier', 'billing executive', 'billing manager', 'senior billing officer', 'accountant']}><BillingDashboard tab="dashboard" /></ProtectedRoute>} />
                            <Route path="billing/patient" element={<ProtectedRoute requiredPermissions={['billing_patient', 'billing_view', 'billing_manage']} allowedRoles={['billing', 'cashier', 'billing executive', 'billing manager', 'senior billing officer']}><BillingDashboard tab="patient" /></ProtectedRoute>} />
                            <Route path="billing/pending" element={<ProtectedRoute requiredPermissions={['billing_pending', 'billing_view', 'billing_manage']} allowedRoles={['billing', 'cashier', 'billing executive', 'billing manager', 'senior billing officer']}><BillingDashboard tab="pending" /></ProtectedRoute>} />
                            <Route path="billing/invoices" element={<ProtectedRoute requiredPermissions={['billing_invoices', 'billing_view', 'billing_manage']} allowedRoles={['billing', 'cashier', 'billing executive', 'billing manager', 'senior billing officer']}><BillingDashboard tab="invoices" /></ProtectedRoute>} />
                            <Route path="billing/collect" element={<ProtectedRoute requiredPermissions={['billing_collect_payment', 'billing_view', 'billing_manage']} allowedRoles={['billing', 'cashier', 'billing executive', 'billing manager', 'senior billing officer']}><BillingDashboard tab="collect" /></ProtectedRoute>} />
                            <Route path="billing/refunds" element={<ProtectedRoute requiredPermissions={['billing_refund', 'billing_view', 'billing_manage']} allowedRoles={['billing', 'cashier', 'billing executive', 'billing manager', 'senior billing officer']}><BillingDashboard tab="refunds" /></ProtectedRoute>} />
                            <Route path="billing/insurance" element={<ProtectedRoute requiredPermissions={['billing_insurance', 'billing_view', 'billing_manage']} allowedRoles={['billing', 'cashier', 'billing executive', 'billing manager', 'senior billing officer', 'accountant']}><InsuranceBilling /></ProtectedRoute>} />
                            <Route path="billing/ipd-settlement" element={<ProtectedRoute requiredPermissions={['billing_ipd_settlement', 'billing_view', 'billing_manage']} allowedRoles={['billing', 'cashier', 'billing executive', 'billing manager', 'senior billing officer']}><IPDSettlement /></ProtectedRoute>} />
                            <Route path="billing/receipt-reprint" element={<ProtectedRoute requiredPermissions={['billing_receipt_reprint', 'billing_view', 'billing_manage']} allowedRoles={['billing', 'cashier', 'billing executive', 'billing manager', 'senior billing officer']}><ReceiptReprint /></ProtectedRoute>} />
